...
#ATTRIBUTE:ConnectionCredentials_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionCredentials_username = Get-AnsibleParam -obj $params -name ConnectionCredentials_username -failifempty $True -resultobj $result
#ATTRIBUTE:ConnectionCredentials_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionCredentials_password = Get-AnsibleParam -obj $params -name ConnectionCredentials_password -failifempty $True -resultobj $result
#ATTRIBUTE:Forest;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Forest = Get-AnsibleParam -obj $params -name Forest -failifempty $True -resultobj $result
#ATTRIBUTE:IncludedOUs;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludedOUs = Get-AnsibleParam -obj $params -name IncludedOUs -failifempty $True -resultobj $result
...
#ATTRIBUTE:ConnectionType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:ActiveDirectory,BusinessDataCatalog
$ConnectionType = Get-AnsibleParam -obj $params -name ConnectionType -failifempty $False -resultobj $result
#ATTRIBUTE:ExcludedOUs;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExcludedOUs = Get-AnsibleParam -obj $params -name ExcludedOUs -failifempty $False -resultobj $result
...
#ATTRIBUTE:Server;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Server = Get-AnsibleParam -obj $params -name Server -failifempty $False -resultobj $result
#ATTRIBUTE:UseSSL;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseSSL = Get-AnsibleParam -obj $params -name UseSSL -failifempty $False -resultobj $result
...
If ($ConnectionType)
{
    If (('ActiveDirectory','BusinessDataCatalog') -contains $ConnectionType ) {
    }
    Else
    {
        Fail-Json $result "Option ConnectionType has invalid value $ConnectionType. Valid values are 'ActiveDirectory','BusinessDataCatalog'"
    }
}
...
if ($ConnectionCredentials_username)
{
$ConnectionCredentials_securepassword = $ConnectionCredentials_password | ConvertTo-SecureString -asPlainText -Force
$ConnectionCredentials = New-Object System.Management.Automation.PSCredential($ConnectionCredentials_username,$ConnectionCredentials_securepassword)
}
...
$DscResourceName = "SPUserProfileSyncConnection"
