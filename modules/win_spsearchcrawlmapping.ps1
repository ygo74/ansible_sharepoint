...
#ATTRIBUTE:Target;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Target = Get-AnsibleParam -obj $params -name Target -failifempty $True -resultobj $result
...
$DscResourceName = "SPSearchCrawlMapping"
