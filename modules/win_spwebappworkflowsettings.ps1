...
#ATTRIBUTE:EmailToNoPermissionWorkflowParticipantsEnable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EmailToNoPermissionWorkflowParticipantsEnable = Get-AnsibleParam -obj $params -name EmailToNoPermissionWorkflowParticipantsEnable -failifempty $False -resultobj $result
#ATTRIBUTE:ExternalWorkflowParticipantsEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExternalWorkflowParticipantsEnabled = Get-AnsibleParam -obj $params -name ExternalWorkflowParticipantsEnabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:UserDefinedWorkflowsEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserDefinedWorkflowsEnabled = Get-AnsibleParam -obj $params -name UserDefinedWorkflowsEnabled -failifempty $False -resultobj $result
...
$DscResourceName = "SPWebAppWorkflowSettings"
