...
#ATTRIBUTE:AdminThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminThreshold = Get-AnsibleParam -obj $params -name AdminThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:AllowObjectModelOverride;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowObjectModelOverride = Get-AnsibleParam -obj $params -name AllowObjectModelOverride -failifempty $False -resultobj $result
#ATTRIBUTE:ChangeLogEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChangeLogEnabled = Get-AnsibleParam -obj $params -name ChangeLogEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:ChangeLogExpiryDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChangeLogExpiryDays = Get-AnsibleParam -obj $params -name ChangeLogExpiryDays -failifempty $False -resultobj $result
#ATTRIBUTE:EventHandlersEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventHandlersEnabled = Get-AnsibleParam -obj $params -name EventHandlersEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:HappyHour;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HappyHour = Get-AnsibleParam -obj $params -name HappyHour -failifempty $False -resultobj $result
#ATTRIBUTE:HappyHourEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HappyHourEnabled = Get-AnsibleParam -obj $params -name HappyHourEnabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:ListViewLookupThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ListViewLookupThreshold = Get-AnsibleParam -obj $params -name ListViewLookupThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:ListViewThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ListViewThreshold = Get-AnsibleParam -obj $params -name ListViewThreshold -failifempty $False -resultobj $result
...
#ATTRIBUTE:RequestThrottling;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RequestThrottling = Get-AnsibleParam -obj $params -name RequestThrottling -failifempty $False -resultobj $result
#ATTRIBUTE:UniquePermissionThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UniquePermissionThreshold = Get-AnsibleParam -obj $params -name UniquePermissionThreshold -failifempty $False -resultobj $result
...
$DscResourceName = "SPWebAppThrottlingSettings"
