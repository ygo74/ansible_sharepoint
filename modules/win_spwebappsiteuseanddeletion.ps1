...
#ATTRIBUTE:AutomaticallyDeleteUnusedSiteCollections;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutomaticallyDeleteUnusedSiteCollections = Get-AnsibleParam -obj $params -name AutomaticallyDeleteUnusedSiteCollections -failifempty $False -resultobj $result
...
#ATTRIBUTE:SendUnusedSiteCollectionNotifications;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SendUnusedSiteCollectionNotifications = Get-AnsibleParam -obj $params -name SendUnusedSiteCollectionNotifications -failifempty $False -resultobj $result
#ATTRIBUTE:UnusedSiteNotificationPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UnusedSiteNotificationPeriod = Get-AnsibleParam -obj $params -name UnusedSiteNotificationPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:UnusedSiteNotificationsBeforeDeletion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UnusedSiteNotificationsBeforeDeletion = Get-AnsibleParam -obj $params -name UnusedSiteNotificationsBeforeDeletion -failifempty $False -resultobj $result
...
$DscResourceName = "SPWebAppSiteUseAndDeletion"
