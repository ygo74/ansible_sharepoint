...
#ATTRIBUTE:Addresses;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Addresses = Get-AnsibleParam -obj $params -name Addresses -failifempty $True -resultobj $result
#ATTRIBUTE:ContentSourceType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:FileShare,SharePoint,Website
$ContentSourceType = Get-AnsibleParam -obj $params -name ContentSourceType -failifempty $True -resultobj $result
#ATTRIBUTE:CrawlSetting;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:CrawlEverything,CrawlFirstOnly,Custom
$CrawlSetting = Get-AnsibleParam -obj $params -name CrawlSetting -failifempty $True -resultobj $result
...
#ATTRIBUTE:ContinuousCrawl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContinuousCrawl = Get-AnsibleParam -obj $params -name ContinuousCrawl -failifempty $False -resultobj $result
...
$Force = Get-AnsibleParam -obj $params -name Force -failifempty $False -resultobj $result
#ATTRIBUTE:FullSchedule;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FullSchedule = Get-AnsibleParam -obj $params -name FullSchedule -failifempty $False -resultobj $result
#ATTRIBUTE:IncrementalSchedule;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncrementalSchedule = Get-AnsibleParam -obj $params -name IncrementalSchedule -failifempty $False -resultobj $result
...
#ATTRIBUTE:LimitPageDepth;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LimitPageDepth = Get-AnsibleParam -obj $params -name LimitPageDepth -failifempty $False -resultobj $result
#ATTRIBUTE:LimitServerHops;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LimitServerHops = Get-AnsibleParam -obj $params -name LimitServerHops -failifempty $False -resultobj $result
#ATTRIBUTE:Priority;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:High,Normal
$Priority = Get-AnsibleParam -obj $params -name Priority -failifempty $False -resultobj $result
...
{
    If (('FileShare','SharePoint','Website') -contains $ContentSourceType ) {
    }
    Else
    {
        Fail-Json $result "Option ContentSourceType has invalid value $ContentSourceType. Valid values are 'FileShare','SharePoint','Website'"
    }
}
...
If ($CrawlSetting)
{
    If (('CrawlEverything','CrawlFirstOnly','Custom') -contains $CrawlSetting ) {
    }
    Else
    {
        Fail-Json $result "Option CrawlSetting has invalid value $CrawlSetting. Valid values are 'CrawlEverything','CrawlFirstOnly','Custom'"
    }
}
...
If ($Priority)
{
    If (('High','Normal') -contains $Priority ) {
    }
    Else
    {
        Fail-Json $result "Option Priority has invalid value $Priority. Valid values are 'High','Normal'"
    }
}
...
$DscResourceName = "SPSearchContentSource"
