...
$autoShutdownExe = Get-AnsibleParam -obj $params -name autoShutdownExe -failifempty $False -resultobj $result
#ATTRIBUTE:autoShutdownParams;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$autoShutdownParams = Get-AnsibleParam -obj $params -name autoShutdownParams -failifempty $False -resultobj $result
#ATTRIBUTE:autoStart;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$autoStart = Get-AnsibleParam -obj $params -name autoStart -failifempty $False -resultobj $result
#ATTRIBUTE:CLRConfigFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CLRConfigFile = Get-AnsibleParam -obj $params -name CLRConfigFile -failifempty $False -resultobj $result
#ATTRIBUTE:cpuAction;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:KillW3wp,NoAction,Throttle,ThrottleUnderLoad
$cpuAction = Get-AnsibleParam -obj $params -name cpuAction -failifempty $False -resultobj $result
#ATTRIBUTE:cpuLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$cpuLimit = Get-AnsibleParam -obj $params -name cpuLimit -failifempty $False -resultobj $result
#ATTRIBUTE:cpuResetInterval;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$cpuResetInterval = Get-AnsibleParam -obj $params -name cpuResetInterval -failifempty $False -resultobj $result
#ATTRIBUTE:cpuSmpAffinitized;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$cpuSmpAffinitized = Get-AnsibleParam -obj $params -name cpuSmpAffinitized -failifempty $False -resultobj $result
#ATTRIBUTE:cpuSmpProcessorAffinityMask;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$cpuSmpProcessorAffinityMask = Get-AnsibleParam -obj $params -name cpuSmpProcessorAffinityMask -failifempty $False -resultobj $result
#ATTRIBUTE:cpuSmpProcessorAffinityMask2;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$cpuSmpProcessorAffinityMask2 = Get-AnsibleParam -obj $params -name cpuSmpProcessorAffinityMask2 -failifempty $False -resultobj $result
#ATTRIBUTE:Credential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Credential_username = Get-AnsibleParam -obj $params -name Credential_username -failifempty $False -resultobj $result
#ATTRIBUTE:Credential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Credential_password = Get-AnsibleParam -obj $params -name Credential_password -failifempty $False -resultobj $result
#ATTRIBUTE:disallowOverlappingRotation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$disallowOverlappingRotation = Get-AnsibleParam -obj $params -name disallowOverlappingRotation -failifempty $False -resultobj $result
#ATTRIBUTE:disallowRotationOnConfigChange;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$disallowRotationOnConfigChange = Get-AnsibleParam -obj $params -name disallowRotationOnConfigChange -failifempty $False -resultobj $result
#ATTRIBUTE:enable32BitAppOnWin64;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$enable32BitAppOnWin64 = Get-AnsibleParam -obj $params -name enable32BitAppOnWin64 -failifempty $False -resultobj $result
#ATTRIBUTE:enableConfigurationOverride;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$enableConfigurationOverride = Get-AnsibleParam -obj $params -name enableConfigurationOverride -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-AnsibleParam -obj $params -name Ensure -failifempty $False -resultobj $result
...
$identityType = Get-AnsibleParam -obj $params -name identityType -failifempty $False -resultobj $result
#ATTRIBUTE:idleTimeout;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$idleTimeout = Get-AnsibleParam -obj $params -name idleTimeout -failifempty $False -resultobj $result
#ATTRIBUTE:idleTimeoutAction;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Suspend,Terminate
$idleTimeoutAction = Get-AnsibleParam -obj $params -name idleTimeoutAction -failifempty $False -resultobj $result
#ATTRIBUTE:loadBalancerCapabilities;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:HttpLevel,TcpLevel
$loadBalancerCapabilities = Get-AnsibleParam -obj $params -name loadBalancerCapabilities -failifempty $False -resultobj $result
#ATTRIBUTE:loadUserProfile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$loadUserProfile = Get-AnsibleParam -obj $params -name loadUserProfile -failifempty $False -resultobj $result
#ATTRIBUTE:logEventOnProcessModel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$logEventOnProcessModel = Get-AnsibleParam -obj $params -name logEventOnProcessModel -failifempty $False -resultobj $result
#ATTRIBUTE:logEventOnRecycle;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$logEventOnRecycle = Get-AnsibleParam -obj $params -name logEventOnRecycle -failifempty $False -resultobj $result
#ATTRIBUTE:logonType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:LogonBatch,LogonService
$logonType = Get-AnsibleParam -obj $params -name logonType -failifempty $False -resultobj $result
#ATTRIBUTE:managedPipelineMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Classic,Integrated
$managedPipelineMode = Get-AnsibleParam -obj $params -name managedPipelineMode -failifempty $False -resultobj $result
#ATTRIBUTE:managedRuntimeLoader;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$managedRuntimeLoader = Get-AnsibleParam -obj $params -name managedRuntimeLoader -failifempty $False -resultobj $result
#ATTRIBUTE:managedRuntimeVersion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:,v2.0,v4.0
$managedRuntimeVersion = Get-AnsibleParam -obj $params -name managedRuntimeVersion -failifempty $False -resultobj $result
#ATTRIBUTE:manualGroupMembership;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$manualGroupMembership = Get-AnsibleParam -obj $params -name manualGroupMembership -failifempty $False -resultobj $result
#ATTRIBUTE:maxProcesses;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$maxProcesses = Get-AnsibleParam -obj $params -name maxProcesses -failifempty $False -resultobj $result
#ATTRIBUTE:orphanActionExe;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$orphanActionExe = Get-AnsibleParam -obj $params -name orphanActionExe -failifempty $False -resultobj $result
#ATTRIBUTE:orphanActionParams;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$orphanActionParams = Get-AnsibleParam -obj $params -name orphanActionParams -failifempty $False -resultobj $result
#ATTRIBUTE:orphanWorkerProcess;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$orphanWorkerProcess = Get-AnsibleParam -obj $params -name orphanWorkerProcess -failifempty $False -resultobj $result
#ATTRIBUTE:passAnonymousToken;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$passAnonymousToken = Get-AnsibleParam -obj $params -name passAnonymousToken -failifempty $False -resultobj $result
#ATTRIBUTE:pingingEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$pingingEnabled = Get-AnsibleParam -obj $params -name pingingEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:pingInterval;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$pingInterval = Get-AnsibleParam -obj $params -name pingInterval -failifempty $False -resultobj $result
#ATTRIBUTE:pingResponseTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$pingResponseTime = Get-AnsibleParam -obj $params -name pingResponseTime -failifempty $False -resultobj $result
...
$queueLength = Get-AnsibleParam -obj $params -name queueLength -failifempty $False -resultobj $result
#ATTRIBUTE:rapidFailProtection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$rapidFailProtection = Get-AnsibleParam -obj $params -name rapidFailProtection -failifempty $False -resultobj $result
#ATTRIBUTE:rapidFailProtectionInterval;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$rapidFailProtectionInterval = Get-AnsibleParam -obj $params -name rapidFailProtectionInterval -failifempty $False -resultobj $result
#ATTRIBUTE:rapidFailProtectionMaxCrashes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$rapidFailProtectionMaxCrashes = Get-AnsibleParam -obj $params -name rapidFailProtectionMaxCrashes -failifempty $False -resultobj $result
#ATTRIBUTE:restartMemoryLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$restartMemoryLimit = Get-AnsibleParam -obj $params -name restartMemoryLimit -failifempty $False -resultobj $result
#ATTRIBUTE:restartPrivateMemoryLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$restartPrivateMemoryLimit = Get-AnsibleParam -obj $params -name restartPrivateMemoryLimit -failifempty $False -resultobj $result
#ATTRIBUTE:restartRequestsLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$restartRequestsLimit = Get-AnsibleParam -obj $params -name restartRequestsLimit -failifempty $False -resultobj $result
#ATTRIBUTE:restartSchedule;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$restartSchedule = Get-AnsibleParam -obj $params -name restartSchedule -failifempty $False -resultobj $result
#ATTRIBUTE:restartTimeLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$restartTimeLimit = Get-AnsibleParam -obj $params -name restartTimeLimit -failifempty $False -resultobj $result
#ATTRIBUTE:setProfileEnvironment;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$setProfileEnvironment = Get-AnsibleParam -obj $params -name setProfileEnvironment -failifempty $False -resultobj $result
#ATTRIBUTE:shutdownTimeLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$shutdownTimeLimit = Get-AnsibleParam -obj $params -name shutdownTimeLimit -failifempty $False -resultobj $result
#ATTRIBUTE:startMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AlwaysRunning,OnDemand
$startMode = Get-AnsibleParam -obj $params -name startMode -failifempty $False -resultobj $result
#ATTRIBUTE:startupTimeLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$startupTimeLimit = Get-AnsibleParam -obj $params -name startupTimeLimit -failifempty $False -resultobj $result
#ATTRIBUTE:State;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Started,Stopped
$State = Get-AnsibleParam -obj $params -name State -failifempty $False -resultobj $result
