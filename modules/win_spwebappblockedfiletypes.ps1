...
#ATTRIBUTE:Blocked;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Blocked = Get-AnsibleParam -obj $params -name Blocked -failifempty $False -resultobj $result
#ATTRIBUTE:EnsureAllowed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnsureAllowed = Get-AnsibleParam -obj $params -name EnsureAllowed -failifempty $False -resultobj $result
#ATTRIBUTE:EnsureBlocked;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnsureBlocked = Get-AnsibleParam -obj $params -name EnsureBlocked -failifempty $False -resultobj $result
...
$DscResourceName = "SPWebAppBlockedFileTypes"
