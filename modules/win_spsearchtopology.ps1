...
#ATTRIBUTE:Admin;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Admin = Get-AnsibleParam -obj $params -name Admin -failifempty $True -resultobj $result
#ATTRIBUTE:AnalyticsProcessing;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AnalyticsProcessing = Get-AnsibleParam -obj $params -name AnalyticsProcessing -failifempty $True -resultobj $result
#ATTRIBUTE:ContentProcessing;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentProcessing = Get-AnsibleParam -obj $params -name ContentProcessing -failifempty $True -resultobj $result
#ATTRIBUTE:Crawler;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Crawler = Get-AnsibleParam -obj $params -name Crawler -failifempty $True -resultobj $result
#ATTRIBUTE:FirstPartitionDirectory;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FirstPartitionDirectory = Get-AnsibleParam -obj $params -name FirstPartitionDirectory -failifempty $True -resultobj $result
#ATTRIBUTE:IndexPartition;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IndexPartition = Get-AnsibleParam -obj $params -name IndexPartition -failifempty $True -resultobj $result
#ATTRIBUTE:QueryProcessing;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$QueryProcessing = Get-AnsibleParam -obj $params -name QueryProcessing -failifempty $True -resultobj $result
...
$DscResourceName = "SPSearchTopology"
