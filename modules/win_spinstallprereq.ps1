...
$OnlineMode = Get-Attr -obj $params -name OnlineMode -failifempty $True -resultobj $result
...
$DotNetFx = Get-Attr -obj $params -name DotNetFx -failifempty $False -resultobj $result
...
$KB3092423 = Get-Attr -obj $params -name KB3092423 -failifempty $False -resultobj $result
...
$MSVCRT11 = Get-Attr -obj $params -name MSVCRT11 -failifempty $False -resultobj $result
#ATTRIBUTE:MSVCRT14;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MSVCRT14 = Get-Attr -obj $params -name MSVCRT14 -failifempty $False -resultobj $result
...
$ODBC = Get-Attr -obj $params -name ODBC -failifempty $False -resultobj $result
...
$SXSpath = Get-Attr -obj $params -name SXSpath -failifempty $False -resultobj $result
