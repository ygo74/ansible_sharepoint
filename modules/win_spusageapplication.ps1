...
#ATTRIBUTE:UsageLogCutTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UsageLogCutTime = Get-AnsibleParam -obj $params -name UsageLogCutTime -failifempty $False -resultobj $result
#ATTRIBUTE:UsageLogLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UsageLogLocation = Get-AnsibleParam -obj $params -name UsageLogLocation -failifempty $False -resultobj $result
#ATTRIBUTE:UsageLogMaxFileSizeKB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UsageLogMaxFileSizeKB = Get-AnsibleParam -obj $params -name UsageLogMaxFileSizeKB -failifempty $False -resultobj $result
#ATTRIBUTE:UsageLogMaxSpaceGB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UsageLogMaxSpaceGB = Get-AnsibleParam -obj $params -name UsageLogMaxSpaceGB -failifempty $False -resultobj $result
...
$DscResourceName = "SPUsageApplication"
