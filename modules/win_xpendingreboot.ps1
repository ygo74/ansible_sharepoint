...
$SkipCcmClientSDK = Get-AnsibleParam -obj $params -name SkipCcmClientSDK -failifempty $False -resultobj $result
#ATTRIBUTE:SkipComponentBasedServicing;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SkipComponentBasedServicing = Get-AnsibleParam -obj $params -name SkipComponentBasedServicing -failifempty $False -resultobj $result
#ATTRIBUTE:SkipPendingComputerRename;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SkipPendingComputerRename = Get-AnsibleParam -obj $params -name SkipPendingComputerRename -failifempty $False -resultobj $result
#ATTRIBUTE:SkipPendingFileRename;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SkipPendingFileRename = Get-AnsibleParam -obj $params -name SkipPendingFileRename -failifempty $False -resultobj $result
#ATTRIBUTE:SkipWindowsUpdate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SkipWindowsUpdate = Get-AnsibleParam -obj $params -name SkipWindowsUpdate -failifempty $False -resultobj $result
