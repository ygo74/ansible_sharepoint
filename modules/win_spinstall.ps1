...
#ATTRIBUTE:ProductKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProductKey = Get-AnsibleParam -obj $params -name ProductKey -failifempty $True -resultobj $result
#ATTRIBUTE:DataPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DataPath = Get-AnsibleParam -obj $params -name DataPath -failifempty $False -resultobj $result
...
$InstallPath = Get-AnsibleParam -obj $params -name InstallPath -failifempty $False -resultobj $result
