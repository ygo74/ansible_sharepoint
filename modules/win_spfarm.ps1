...
#ATTRIBUTE:AdminContentDatabaseName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminContentDatabaseName = Get-AnsibleParam -obj $params -name AdminContentDatabaseName -failifempty $True -resultobj $result
#ATTRIBUTE:DatabaseServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseServer = Get-AnsibleParam -obj $params -name DatabaseServer -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-AnsibleParam -obj $params -name Ensure -failifempty $True -resultobj $result
#ATTRIBUTE:FarmAccount_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmAccount_username = Get-AnsibleParam -obj $params -name FarmAccount_username -failifempty $True -resultobj $result
#ATTRIBUTE:FarmAccount_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmAccount_password = Get-AnsibleParam -obj $params -name FarmAccount_password -failifempty $True -resultobj $result
#ATTRIBUTE:FarmConfigDatabaseName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmConfigDatabaseName = Get-AnsibleParam -obj $params -name FarmConfigDatabaseName -failifempty $True -resultobj $result
#ATTRIBUTE:Passphrase_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Passphrase_username = Get-AnsibleParam -obj $params -name Passphrase_username -failifempty $True -resultobj $result
#ATTRIBUTE:Passphrase_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Passphrase_password = Get-AnsibleParam -obj $params -name Passphrase_password -failifempty $True -resultobj $result
#ATTRIBUTE:RunCentralAdmin;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RunCentralAdmin = Get-AnsibleParam -obj $params -name RunCentralAdmin -failifempty $True -resultobj $result
#ATTRIBUTE:CentralAdministrationAuth;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Kerberos,NTLM
$CentralAdministrationAuth = Get-AnsibleParam -obj $params -name CentralAdministrationAuth -failifempty $False -resultobj $result
#ATTRIBUTE:CentralAdministrationPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CentralAdministrationPort = Get-AnsibleParam -obj $params -name CentralAdministrationPort -failifempty $False -resultobj $result
...
#ATTRIBUTE:ServerRole;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Application,ApplicationWithSearch,Custom,DistributedCache,Search,SingleServer,SingleServerFarm,WebFrontEnd,WebFrontEndWithDistributedCache
$ServerRole = Get-AnsibleParam -obj $params -name ServerRole -failifempty $False -resultobj $result
...
If ($CentralAdministrationAuth)
{
    If (('Kerberos','NTLM') -contains $CentralAdministrationAuth ) {
    }
    Else
    {
        Fail-Json $result "Option CentralAdministrationAuth has invalid value $CentralAdministrationAuth. Valid values are 'Kerberos','NTLM'"
    }
}
...
If ($ServerRole)
{
    If (('Application','ApplicationWithSearch','Custom','DistributedCache','Search','SingleServer','SingleServerFarm','WebFrontEnd','WebFrontEndWithDistributedCache') -contains $ServerRole ) {
    }
    Else
    {
        Fail-Json $result "Option ServerRole has invalid value $ServerRole. Valid values are 'Application','ApplicationWithSearch','Custom','DistributedCache','Search','SingleServer','SingleServerFarm','WebFrontEnd','WebFrontEndWithDistributedCache'"
    }
}
...
$FarmAccount = New-Object System.Management.Automation.PSCredential($FarmAccount_username,$FarmAccount_securepassword)
}
