...
#ATTRIBUTE:MinimumTimeBetweenEwsSyncSubscriptionSearches;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinimumTimeBetweenEwsSyncSubscriptionSearches = Get-AnsibleParam -obj $params -name MinimumTimeBetweenEwsSyncSubscriptionSearches -failifempty $False -resultobj $result
#ATTRIBUTE:MinimumTimeBetweenProviderRefreshes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinimumTimeBetweenProviderRefreshes = Get-AnsibleParam -obj $params -name MinimumTimeBetweenProviderRefreshes -failifempty $False -resultobj $result
#ATTRIBUTE:MinimumTimeBetweenSearchQueries;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinimumTimeBetweenSearchQueries = Get-AnsibleParam -obj $params -name MinimumTimeBetweenSearchQueries -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfSubscriptionSyncsPerEwsSyncRun;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfSubscriptionSyncsPerEwsSyncRun = Get-AnsibleParam -obj $params -name NumberOfSubscriptionSyncsPerEwsSyncRun -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfUsersEwsSyncWillProcessAtOnce;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfUsersEwsSyncWillProcessAtOnce = Get-AnsibleParam -obj $params -name NumberOfUsersEwsSyncWillProcessAtOnce -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfUsersPerEwsSyncBatch;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfUsersPerEwsSyncBatch = Get-AnsibleParam -obj $params -name NumberOfUsersPerEwsSyncBatch -failifempty $False -resultobj $result
...
$DscResourceName = "SPWorkManagementServiceApp"
