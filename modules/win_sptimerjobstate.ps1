...
#ATTRIBUTE:WebApplication;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebApplication = Get-AnsibleParam -obj $params -name WebApplication -failifempty $False -resultobj $result
...
$DscResourceName = "SPTimerJobState"
