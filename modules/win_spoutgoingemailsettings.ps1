...
#ATTRIBUTE:CharacterSet;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CharacterSet = Get-AnsibleParam -obj $params -name CharacterSet -failifempty $True -resultobj $result
#ATTRIBUTE:FromAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FromAddress = Get-AnsibleParam -obj $params -name FromAddress -failifempty $True -resultobj $result
#ATTRIBUTE:ReplyToAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReplyToAddress = Get-AnsibleParam -obj $params -name ReplyToAddress -failifempty $True -resultobj $result
#ATTRIBUTE:SMTPServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SMTPServer = Get-AnsibleParam -obj $params -name SMTPServer -failifempty $True -resultobj $result
...
$DscResourceName = "SPOutgoingEmailSettings"
