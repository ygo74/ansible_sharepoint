...
$OwnerAlias = Get-AnsibleParam -obj $params -name OwnerAlias -failifempty $True -resultobj $result
...
$CompatibilityLevel = Get-AnsibleParam -obj $params -name CompatibilityLevel -failifempty $False -resultobj $result
#ATTRIBUTE:ContentDatabase;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentDatabase = Get-AnsibleParam -obj $params -name ContentDatabase -failifempty $False -resultobj $result
...
$HostHeaderWebApplication = Get-AnsibleParam -obj $params -name HostHeaderWebApplication -failifempty $False -resultobj $result
...
$Language = Get-AnsibleParam -obj $params -name Language -failifempty $False -resultobj $result
#ATTRIBUTE:Name;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Name = Get-AnsibleParam -obj $params -name Name -failifempty $False -resultobj $result
#ATTRIBUTE:OwnerEmail;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OwnerEmail = Get-AnsibleParam -obj $params -name OwnerEmail -failifempty $False -resultobj $result
...
$QuotaTemplate = Get-AnsibleParam -obj $params -name QuotaTemplate -failifempty $False -resultobj $result
#ATTRIBUTE:SecondaryEmail;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecondaryEmail = Get-AnsibleParam -obj $params -name SecondaryEmail -failifempty $False -resultobj $result
#ATTRIBUTE:SecondaryOwnerAlias;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecondaryOwnerAlias = Get-AnsibleParam -obj $params -name SecondaryOwnerAlias -failifempty $False -resultobj $result
#ATTRIBUTE:Template;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Template = Get-AnsibleParam -obj $params -name Template -failifempty $False -resultobj $result
