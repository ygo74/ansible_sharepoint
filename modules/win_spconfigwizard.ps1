...
#ATTRIBUTE:DatabaseUpgradeDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:fri,mon,sat,sun,thu,tue,wed
$DatabaseUpgradeDays = Get-AnsibleParam -obj $params -name DatabaseUpgradeDays -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseUpgradeTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseUpgradeTime = Get-AnsibleParam -obj $params -name DatabaseUpgradeTime -failifempty $False -resultobj $result
...
{
    If (('fri','mon','sat','sun','thu','tue','wed') -contains $DatabaseUpgradeDays ) {
    }
    Else
    {
        Fail-Json $result "Option DatabaseUpgradeDays has invalid value $DatabaseUpgradeDays. Valid values are 'fri','mon','sat','sun','thu','tue','wed'"
    }
}
...
$DscResourceName = "SPConfigWizard"
