...
#ATTRIBUTE:Url;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Url = Get-AnsibleParam -obj $params -name Url -failifempty $False -resultobj $result
...
$DscResourceName = "SPAlternateUrl"
