...
#ATTRIBUTE:ContentTypeHubUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentTypeHubUrl = Get-AnsibleParam -obj $params -name ContentTypeHubUrl -failifempty $False -resultobj $result
...
#ATTRIBUTE:TermStoreAdministrators;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TermStoreAdministrators = Get-AnsibleParam -obj $params -name TermStoreAdministrators -failifempty $False -resultobj $result
...
$DscResourceName = "SPManagedMetaDataServiceApp"
