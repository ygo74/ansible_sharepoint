...
$ApplicationPool = Get-AnsibleParam -obj $params -name ApplicationPool -failifempty $True -resultobj $result
...
#ATTRIBUTE:CachingOfUnusedFilesEnable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CachingOfUnusedFilesEnable = Get-AnsibleParam -obj $params -name CachingOfUnusedFilesEnable -failifempty $False -resultobj $result
#ATTRIBUTE:CrossDomainAccessAllowed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CrossDomainAccessAllowed = Get-AnsibleParam -obj $params -name CrossDomainAccessAllowed -failifempty $False -resultobj $result
#ATTRIBUTE:EncryptedUserConnectionRequired;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Connection,None
$EncryptedUserConnectionRequired = Get-AnsibleParam -obj $params -name EncryptedUserConnectionRequired -failifempty $False -resultobj $result
...
#ATTRIBUTE:ExternalDataConnectionLifetime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExternalDataConnectionLifetime = Get-AnsibleParam -obj $params -name ExternalDataConnectionLifetime -failifempty $False -resultobj $result
#ATTRIBUTE:FileAccessMethod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:UseFileAccessAccount,UseImpersonation
$FileAccessMethod = Get-AnsibleParam -obj $params -name FileAccessMethod -failifempty $False -resultobj $result
...
#ATTRIBUTE:LoadBalancingScheme;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Local,RoundRobin,WorkbookURL
$LoadBalancingScheme = Get-AnsibleParam -obj $params -name LoadBalancingScheme -failifempty $False -resultobj $result
#ATTRIBUTE:MemoryCacheThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MemoryCacheThreshold = Get-AnsibleParam -obj $params -name MemoryCacheThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:PrivateBytesMax;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrivateBytesMax = Get-AnsibleParam -obj $params -name PrivateBytesMax -failifempty $False -resultobj $result
...
#ATTRIBUTE:SessionsPerUserMax;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SessionsPerUserMax = Get-AnsibleParam -obj $params -name SessionsPerUserMax -failifempty $False -resultobj $result
#ATTRIBUTE:SiteCollectionAnonymousSessionsMax;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteCollectionAnonymousSessionsMax = Get-AnsibleParam -obj $params -name SiteCollectionAnonymousSessionsMax -failifempty $False -resultobj $result
#ATTRIBUTE:TerminateProcessOnAccessViolation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TerminateProcessOnAccessViolation = Get-AnsibleParam -obj $params -name TerminateProcessOnAccessViolation -failifempty $False -resultobj $result
#ATTRIBUTE:ThrottleAccessViolationsPerSiteCollection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ThrottleAccessViolationsPerSiteCollection = Get-AnsibleParam -obj $params -name ThrottleAccessViolationsPerSiteCollection -failifempty $False -resultobj $result
#ATTRIBUTE:TrustedFileLocations;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TrustedFileLocations = Get-AnsibleParam -obj $params -name TrustedFileLocations -failifempty $False -resultobj $result
#ATTRIBUTE:UnattendedAccountApplicationId;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UnattendedAccountApplicationId = Get-AnsibleParam -obj $params -name UnattendedAccountApplicationId -failifempty $False -resultobj $result
#ATTRIBUTE:UnusedObjectAgeMax;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UnusedObjectAgeMax = Get-AnsibleParam -obj $params -name UnusedObjectAgeMax -failifempty $False -resultobj $result
#ATTRIBUTE:WorkbookCache;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkbookCache = Get-AnsibleParam -obj $params -name WorkbookCache -failifempty $False -resultobj $result
#ATTRIBUTE:WorkbookCacheSizeMax;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkbookCacheSizeMax = Get-AnsibleParam -obj $params -name WorkbookCacheSizeMax -failifempty $False -resultobj $result
...
If ($EncryptedUserConnectionRequired)
{
    If (('Connection','None') -contains $EncryptedUserConnectionRequired ) {
    }
    Else
    {
        Fail-Json $result "Option EncryptedUserConnectionRequired has invalid value $EncryptedUserConnectionRequired. Valid values are 'Connection','None'"
    }
}
...
If ($FileAccessMethod)
{
    If (('UseFileAccessAccount','UseImpersonation') -contains $FileAccessMethod ) {
    }
    Else
    {
        Fail-Json $result "Option FileAccessMethod has invalid value $FileAccessMethod. Valid values are 'UseFileAccessAccount','UseImpersonation'"
    }
}


If ($LoadBalancingScheme)
{
    If (('Local','RoundRobin','WorkbookURL') -contains $LoadBalancingScheme ) {
    }
    Else
    {
        Fail-Json $result "Option LoadBalancingScheme has invalid value $LoadBalancingScheme. Valid values are 'Local','RoundRobin','WorkbookURL'"
    }
}
...
$DscResourceName = "SPExcelServiceApp"
