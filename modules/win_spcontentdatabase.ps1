...
$Enabled = Get-AnsibleParam -obj $params -name Enabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:MaximumSiteCount;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumSiteCount = Get-AnsibleParam -obj $params -name MaximumSiteCount -failifempty $False -resultobj $result
...
#ATTRIBUTE:WarningSiteCount;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WarningSiteCount = Get-AnsibleParam -obj $params -name WarningSiteCount -failifempty $False -resultobj $result
...
$DscResourceName = "SPContentDatabase"
