...
#ATTRIBUTE:SetCacheAccountsPolicy;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetCacheAccountsPolicy = Get-AnsibleParam -obj $params -name SetCacheAccountsPolicy -failifempty $False -resultobj $result
...
$DscResourceName = "SPWebAppPolicy"
