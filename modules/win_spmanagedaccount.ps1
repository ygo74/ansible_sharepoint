...
#ATTRIBUTE:AccountName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AccountName = Get-AnsibleParam -obj $params -name AccountName -failifempty $True -resultobj $result
#ATTRIBUTE:Account_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Account_username = Get-AnsibleParam -obj $params -name Account_username -failifempty $False -resultobj $result
#ATTRIBUTE:Account_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Account_password = Get-AnsibleParam -obj $params -name Account_password -failifempty $False -resultobj $result
#ATTRIBUTE:EmailNotification;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EmailNotification = Get-AnsibleParam -obj $params -name EmailNotification -failifempty $False -resultobj $result
...
#ATTRIBUTE:PreExpireDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PreExpireDays = Get-AnsibleParam -obj $params -name PreExpireDays -failifempty $False -resultobj $result
...
#ATTRIBUTE:Schedule;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Schedule = Get-AnsibleParam -obj $params -name Schedule -failifempty $False -resultobj $result
...
if ($Account_username)
{
$Account_securepassword = $Account_password | ConvertTo-SecureString -asPlainText -Force
$Account = New-Object System.Management.Automation.PSCredential($Account_username,$Account_securepassword)
}
...
$DscResourceName = "SPManagedAccount"
