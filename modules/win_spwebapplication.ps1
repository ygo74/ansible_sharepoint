...
#ATTRIBUTE:ApplicationPoolAccount;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ApplicationPoolAccount = Get-AnsibleParam -obj $params -name ApplicationPoolAccount -failifempty $True -resultobj $result
...
$DscResourceName = "SPWebApplication"
