...
#ATTRIBUTE:LocalWebAppUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LocalWebAppUrl = Get-AnsibleParam -obj $params -name LocalWebAppUrl -failifempty $True -resultobj $result
...
#ATTRIBUTE:RemoteWebAppUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RemoteWebAppUrl = Get-AnsibleParam -obj $params -name RemoteWebAppUrl -failifempty $True -resultobj $result
...
$DscResourceName = "SPRemoteFarmTrust"
