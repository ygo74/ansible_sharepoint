...
#ATTRIBUTE:MaximumUsagePointsSolutions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumUsagePointsSolutions = Get-AnsibleParam -obj $params -name MaximumUsagePointsSolutions -failifempty $False -resultobj $result
...
#ATTRIBUTE:StorageMaxInMB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StorageMaxInMB = Get-AnsibleParam -obj $params -name StorageMaxInMB -failifempty $False -resultobj $result
#ATTRIBUTE:StorageWarningInMB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StorageWarningInMB = Get-AnsibleParam -obj $params -name StorageWarningInMB -failifempty $False -resultobj $result
#ATTRIBUTE:WarningUsagePointsSolutions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WarningUsagePointsSolutions = Get-AnsibleParam -obj $params -name WarningUsagePointsSolutions -failifempty $False -resultobj $result
...
$DscResourceName = "SPQuotaTemplate"
