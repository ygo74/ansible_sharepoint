...
#ATTRIBUTE:ServiceAppProxyGroup;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppProxyGroup = Get-AnsibleParam -obj $params -name ServiceAppProxyGroup -failifempty $True -resultobj $result
...
$DscResourceName = "SPWebAppProxyGroup"
