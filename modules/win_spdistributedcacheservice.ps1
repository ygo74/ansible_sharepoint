...
#ATTRIBUTE:CacheSizeInMB;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CacheSizeInMB = Get-AnsibleParam -obj $params -name CacheSizeInMB -failifempty $True -resultobj $result
#ATTRIBUTE:CreateFirewallRules;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CreateFirewallRules = Get-AnsibleParam -obj $params -name CreateFirewallRules -failifempty $True -resultobj $result
...
#ATTRIBUTE:ServiceAccount;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAccount = Get-AnsibleParam -obj $params -name ServiceAccount -failifempty $True -resultobj $result
...
#ATTRIBUTE:ServerProvisionOrder;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServerProvisionOrder = Get-AnsibleParam -obj $params -name ServerProvisionOrder -failifempty $False -resultobj $result
...
$DscResourceName = "SPDistributedCacheService"
