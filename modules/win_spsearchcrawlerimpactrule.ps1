...
#ATTRIBUTE:RequestLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RequestLimit = Get-AnsibleParam -obj $params -name RequestLimit -failifempty $False -resultobj $result
#ATTRIBUTE:WaitTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WaitTime = Get-AnsibleParam -obj $params -name WaitTime -failifempty $False -resultobj $result
...
$DscResourceName = "SPSearchCrawlerImpactRule"
