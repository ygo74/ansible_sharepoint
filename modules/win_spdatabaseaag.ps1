...
#ATTRIBUTE:AGName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AGName = Get-AnsibleParam -obj $params -name AGName -failifempty $True -resultobj $result
...
#ATTRIBUTE:FileShare;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FileShare = Get-AnsibleParam -obj $params -name FileShare -failifempty $False -resultobj $result
