...
$ApplicationPool = Get-AnsibleParam -obj $params -name ApplicationPool -failifempty $False -resultobj $result
#ATTRIBUTE:ConversionProcesses;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConversionProcesses = Get-AnsibleParam -obj $params -name ConversionProcesses -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseName = Get-AnsibleParam -obj $params -name DatabaseName -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseServer = Get-AnsibleParam -obj $params -name DatabaseServer -failifempty $False -resultobj $result
#ATTRIBUTE:DisableBinaryFileScan;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisableBinaryFileScan = Get-AnsibleParam -obj $params -name DisableBinaryFileScan -failifempty $False -resultobj $result
#ATTRIBUTE:DisableEmbeddedFonts;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisableEmbeddedFonts = Get-AnsibleParam -obj $params -name DisableEmbeddedFonts -failifempty $False -resultobj $result
...
#ATTRIBUTE:JobConversionFrequency;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$JobConversionFrequency = Get-AnsibleParam -obj $params -name JobConversionFrequency -failifempty $False -resultobj $result
#ATTRIBUTE:KeepAliveTimeout;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeepAliveTimeout = Get-AnsibleParam -obj $params -name KeepAliveTimeout -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumConversionAttempts;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumConversionAttempts = Get-AnsibleParam -obj $params -name MaximumConversionAttempts -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumConversionTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumConversionTime = Get-AnsibleParam -obj $params -name MaximumConversionTime -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumMemoryUsage;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumMemoryUsage = Get-AnsibleParam -obj $params -name MaximumMemoryUsage -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumSyncConversionRequests;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumSyncConversionRequests = Get-AnsibleParam -obj $params -name MaximumSyncConversionRequests -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfConversionsPerProcess;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfConversionsPerProcess = Get-AnsibleParam -obj $params -name NumberOfConversionsPerProcess -failifempty $False -resultobj $result
...
#ATTRIBUTE:RecycleThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RecycleThreshold = Get-AnsibleParam -obj $params -name RecycleThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:SupportedFileFormats;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:doc,docx,mht,rtf,xml
$SupportedFileFormats = Get-AnsibleParam -obj $params -name SupportedFileFormats -failifempty $False -resultobj $result
#ATTRIBUTE:TimeBeforeConversionIsMonitored;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeBeforeConversionIsMonitored = Get-AnsibleParam -obj $params -name TimeBeforeConversionIsMonitored -failifempty $False -resultobj $result
...
{
    If (('doc','docx','mht','rtf','xml') -contains $SupportedFileFormats ) {
    }
    Else
    {
        Fail-Json $result "Option SupportedFileFormats has invalid value $SupportedFileFormats. Valid values are 'doc','docx','mht','rtf','xml'"
    }
}
...
$DscResourceName = "SPWordAutomationServiceApp"
