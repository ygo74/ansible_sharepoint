...
$Url = Get-AnsibleParam -obj $params -name Url -failifempty $True -resultobj $result
#ATTRIBUTE:Alerts;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Alerts = Get-AnsibleParam -obj $params -name Alerts -failifempty $False -resultobj $result
#ATTRIBUTE:AlertsLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AlertsLimit = Get-AnsibleParam -obj $params -name AlertsLimit -failifempty $False -resultobj $result
#ATTRIBUTE:AllowOnlineWebPartCatalog;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowOnlineWebPartCatalog = Get-AnsibleParam -obj $params -name AllowOnlineWebPartCatalog -failifempty $False -resultobj $result
#ATTRIBUTE:BlogAPI;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BlogAPI = Get-AnsibleParam -obj $params -name BlogAPI -failifempty $False -resultobj $result
#ATTRIBUTE:BlogAPIAuthenticated;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BlogAPIAuthenticated = Get-AnsibleParam -obj $params -name BlogAPIAuthenticated -failifempty $False -resultobj $result
#ATTRIBUTE:BrowserFileHandling;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Permissive,Strict
$BrowserFileHandling = Get-AnsibleParam -obj $params -name BrowserFileHandling -failifempty $False -resultobj $result
#ATTRIBUTE:CustomerExperienceProgram;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CustomerExperienceProgram = Get-AnsibleParam -obj $params -name CustomerExperienceProgram -failifempty $False -resultobj $result
...
#ATTRIBUTE:MaximumUploadSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumUploadSize = Get-AnsibleParam -obj $params -name MaximumUploadSize -failifempty $False -resultobj $result
#ATTRIBUTE:PresenceEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PresenceEnabled = Get-AnsibleParam -obj $params -name PresenceEnabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:RecycleBinCleanupEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RecycleBinCleanupEnabled = Get-AnsibleParam -obj $params -name RecycleBinCleanupEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:RecycleBinEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RecycleBinEnabled = Get-AnsibleParam -obj $params -name RecycleBinEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:RecycleBinRetentionPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RecycleBinRetentionPeriod = Get-AnsibleParam -obj $params -name RecycleBinRetentionPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:RSS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RSS = Get-AnsibleParam -obj $params -name RSS -failifempty $False -resultobj $result
#ATTRIBUTE:SecondStageRecycleBinQuota;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecondStageRecycleBinQuota = Get-AnsibleParam -obj $params -name SecondStageRecycleBinQuota -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityValidation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityValidation = Get-AnsibleParam -obj $params -name SecurityValidation -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityValidationExpires;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityValidationExpires = Get-AnsibleParam -obj $params -name SecurityValidationExpires -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityValidationTimeOutMinutes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityValidationTimeOutMinutes = Get-AnsibleParam -obj $params -name SecurityValidationTimeOutMinutes -failifempty $False -resultobj $result
#ATTRIBUTE:SelfServiceSiteCreationEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SelfServiceSiteCreationEnabled = Get-AnsibleParam -obj $params -name SelfServiceSiteCreationEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:TimeZone;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeZone = Get-AnsibleParam -obj $params -name TimeZone -failifempty $False -resultobj $result
...
If ($BrowserFileHandling)
{
    If (('Permissive','Strict') -contains $BrowserFileHandling ) {
    }
    Else
    {
        Fail-Json $result "Option BrowserFileHandling has invalid value $BrowserFileHandling. Valid values are 'Permissive','Strict'"
    }
}
...
$DscResourceName = "SPWebAppGeneralSettings"
