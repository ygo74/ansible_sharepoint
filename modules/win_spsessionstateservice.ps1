...
#ATTRIBUTE:SessionTimeout;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SessionTimeout = Get-AnsibleParam -obj $params -name SessionTimeout -failifempty $False -resultobj $result
...
$DscResourceName = "SPSessionStateService"
