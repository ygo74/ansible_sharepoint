...
#ATTRIBUTE:EnableCache;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableCache = Get-AnsibleParam -obj $params -name EnableCache -failifempty $True -resultobj $result
...
#ATTRIBUTE:FileTypes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FileTypes = Get-AnsibleParam -obj $params -name FileTypes -failifempty $False -resultobj $result
...
#ATTRIBUTE:Location;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Location = Get-AnsibleParam -obj $params -name Location -failifempty $False -resultobj $result
#ATTRIBUTE:MaxAgeInSeconds;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxAgeInSeconds = Get-AnsibleParam -obj $params -name MaxAgeInSeconds -failifempty $False -resultobj $result
#ATTRIBUTE:MaxSizeInGB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxSizeInGB = Get-AnsibleParam -obj $params -name MaxSizeInGB -failifempty $False -resultobj $result
...
$DscResourceName = "SPBlobCacheSettings"
