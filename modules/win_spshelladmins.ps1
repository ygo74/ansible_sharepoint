...
#ATTRIBUTE:AllContentDatabases;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllContentDatabases = Get-AnsibleParam -obj $params -name AllContentDatabases -failifempty $False -resultobj $result
#ATTRIBUTE:ContentDatabases;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentDatabases = Get-AnsibleParam -obj $params -name ContentDatabases -failifempty $False -resultobj $result
