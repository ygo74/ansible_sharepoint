...
#ATTRIBUTE:AppDomain;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AppDomain = Get-AnsibleParam -obj $params -name AppDomain -failifempty $True -resultobj $result
#ATTRIBUTE:WebApplication;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebApplication = Get-AnsibleParam -obj $params -name WebApplication -failifempty $True -resultobj $result
...
#ATTRIBUTE:SSL;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SSL = Get-AnsibleParam -obj $params -name SSL -failifempty $False -resultobj $result
...
$DscResourceName = "SPWebApplicationAppDomain"
