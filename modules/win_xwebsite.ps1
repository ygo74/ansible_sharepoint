...
$ApplicationType = Get-AnsibleParam  -obj $params -name ApplicationType -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationInfo;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationInfo = Get-AnsibleParam  -obj $params -name AuthenticationInfo -failifempty $False -resultobj $result
#ATTRIBUTE:BindingInfo;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BindingInfo = Get-AnsibleParam  -obj $params -name BindingInfo -failifempty $False -resultobj $result
#ATTRIBUTE:DefaultPage;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultPage = Get-AnsibleParam  -obj $params -name DefaultPage -failifempty $False -resultobj $result
#ATTRIBUTE:EnabledProtocols;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnabledProtocols = Get-AnsibleParam  -obj $params -name EnabledProtocols -failifempty $False -resultobj $result
...
$LogFlags = Get-AnsibleParam  -obj $params -name LogFlags -failifempty $False -resultobj $result
#ATTRIBUTE:LogFormat;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:IIS,NCSA,W3C
$LogFormat = Get-AnsibleParam  -obj $params -name LogFormat -failifempty $False -resultobj $result
#ATTRIBUTE:LoglocalTimeRollover;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoglocalTimeRollover = Get-AnsibleParam  -obj $params -name LoglocalTimeRollover -failifempty $False -resultobj $result
#ATTRIBUTE:LogPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogPath = Get-AnsibleParam  -obj $params -name LogPath -failifempty $False -resultobj $result
#ATTRIBUTE:LogPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Daily,Hourly,MaxSize,Monthly,Weekly
$LogPeriod = Get-AnsibleParam  -obj $params -name LogPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:LogTruncateSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogTruncateSize = Get-AnsibleParam  -obj $params -name LogTruncateSize -failifempty $False -resultobj $result
#ATTRIBUTE:PhysicalPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PhysicalPath = Get-AnsibleParam  -obj $params -name PhysicalPath -failifempty $False -resultobj $result
#ATTRIBUTE:PreloadEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PreloadEnabled = Get-AnsibleParam  -obj $params -name PreloadEnabled -failifempty $False -resultobj $result
...
$ServiceAutoStartEnabled = Get-AnsibleParam  -obj $params -name ServiceAutoStartEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceAutoStartProvider;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAutoStartProvider = Get-AnsibleParam  -obj $params -name ServiceAutoStartProvider -failifempty $False -resultobj $result
...
set-attr -obj $result -name "Attributes" -value $Attribut
...
$CheckFlag = $params.GetEnumerator() | where {$_.key -eq "_ansible_check_mode"}
if ($CheckFlag)
{
...
$attrib.Keys | foreach-object {
    ...
    ElseIf ($prop.PropertyType -eq "[CimInstance[]]" -or $prop.PropertyType.StartsWith("[MSFT_"))
    {
      ...
      set-attr -obj $result -name KeyValueStr -value $KeyValueStr

      foreach($str in $KeyValueStr)
      {
        [string[]]$properties = $str.Trim().Split("{",[System.StringSplitOptions]::RemoveEmptyEntries)[1].Replace("}","").Trim().Split(",",[System.StringSplitOptions]::RemoveEmptyEntries).Trim()
          set-attr -obj $result -name properties -value $properties
        $prph = @{}
        ...
        $cimInstanceName=$str.Trim().Split("{",[System.StringSplitOptions]::RemoveEmptyEntries)[0].Trim().Replace("}","")
        set-attr -obj $result -name cimInstanceName -value $cimInstanceName

        set-attr -obj $result -name prph -value $prph

        $cimNamespace = 'root/microsoft/Windows/DesiredStateConfiguration'
        $cim = New-CimInstance -ClassName $cimInstanceName -Namespace $cimNamespace -Property $prph -ClientOnly

        set-attr -obj $result -name cim -value $cim
