...
#ATTRIBUTE:UserProfileServiceAppName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserProfileServiceAppName = Get-AnsibleParam -obj $params -name UserProfileServiceAppName -failifempty $True -resultobj $result
...
#ATTRIBUTE:RunOnlyWhenWriteable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RunOnlyWhenWriteable = Get-AnsibleParam -obj $params -name RunOnlyWhenWriteable -failifempty $False -resultobj $result
...
$DscResourceName = "SPUserProfileSyncService"
