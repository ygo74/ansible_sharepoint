...
#ATTRIBUTE:Index;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Index = Get-AnsibleParam -obj $params -name Index -failifempty $True -resultobj $result
#ATTRIBUTE:Servers;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Servers = Get-AnsibleParam -obj $params -name Servers -failifempty $True -resultobj $result
...
#ATTRIBUTE:RootDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RootDirectory = Get-AnsibleParam -obj $params -name RootDirectory -failifempty $False -resultobj $result
...
$DscResourceName = "SPSearchIndexPartition"
