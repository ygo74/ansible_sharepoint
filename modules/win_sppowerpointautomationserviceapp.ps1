...
#ATTRIBUTE:CacheExpirationPeriodInSeconds;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CacheExpirationPeriodInSeconds = Get-AnsibleParam -obj $params -name CacheExpirationPeriodInSeconds -failifempty $False -resultobj $result
...
#ATTRIBUTE:MaximumConversionsPerWorker;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumConversionsPerWorker = Get-AnsibleParam -obj $params -name MaximumConversionsPerWorker -failifempty $False -resultobj $result
...
#ATTRIBUTE:WorkerKeepAliveTimeoutInSeconds;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkerKeepAliveTimeoutInSeconds = Get-AnsibleParam -obj $params -name WorkerKeepAliveTimeoutInSeconds -failifempty $False -resultobj $result
#ATTRIBUTE:WorkerProcessCount;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkerProcessCount = Get-AnsibleParam -obj $params -name WorkerProcessCount -failifempty $False -resultobj $result
#ATTRIBUTE:WorkerTimeoutInSeconds;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkerTimeoutInSeconds = Get-AnsibleParam -obj $params -name WorkerTimeoutInSeconds -failifempty $False -resultobj $result
...
$DscResourceName = "SPPowerPointAutomationServiceApp"
