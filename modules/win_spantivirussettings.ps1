...
#ATTRIBUTE:ScanOnDownload;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScanOnDownload = Get-AnsibleParam -obj $params -name ScanOnDownload -failifempty $True -resultobj $result
#ATTRIBUTE:AllowDownloadInfected;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowDownloadInfected = Get-AnsibleParam -obj $params -name AllowDownloadInfected -failifempty $False -resultobj $result
#ATTRIBUTE:AttemptToClean;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttemptToClean = Get-AnsibleParam -obj $params -name AttemptToClean -failifempty $False -resultobj $result
...
#ATTRIBUTE:NumberOfThreads;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfThreads = Get-AnsibleParam -obj $params -name NumberOfThreads -failifempty $False -resultobj $result
...
#ATTRIBUTE:ScanOnUpload;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScanOnUpload = Get-AnsibleParam -obj $params -name ScanOnUpload -failifempty $False -resultobj $result
#ATTRIBUTE:TimeoutDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeoutDuration = Get-AnsibleParam -obj $params -name TimeoutDuration -failifempty $False -resultobj $result
...
$DscResourceName = "SPAntivirusSettings"
