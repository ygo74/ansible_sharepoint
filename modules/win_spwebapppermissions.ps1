...
#ATTRIBUTE:WebAppUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebAppUrl = Get-AnsibleParam -obj $params -name WebAppUrl -failifempty $True -resultobj $result
#ATTRIBUTE:AllPermissions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllPermissions = Get-AnsibleParam -obj $params -name AllPermissions -failifempty $False -resultobj $result
...
#ATTRIBUTE:ListPermissions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Add Items,Approve Items,Create Alerts,Delete Items,Delete Versions,Edit Items,Manage Lists,Open Items,Override List Behaviors,View Application Pages,View Items,View Versions
$ListPermissions = Get-AnsibleParam -obj $params -name ListPermissions -failifempty $False -resultobj $result
#ATTRIBUTE:PersonalPermissions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Add/Remove Personal Web Parts,Manage Personal Views,Update Personal Web Parts
$PersonalPermissions = Get-AnsibleParam -obj $params -name PersonalPermissions -failifempty $False -resultobj $result
...
#ATTRIBUTE:SitePermissions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Add and Customize Pages,Apply Style Sheets,Apply Themes and Borders,Browse Directories,Browse User Information,Create Groups,Create Subsites,Edit Personal User Information,Enumerate Permissions,Manage Alerts,Manage Permissions,Manage Web Site,Open,Use Client Integration Features,Use Remote Interfaces,Use Self-Service Site Creation,View Pages,View Web Analytics Data
$SitePermissions = Get-AnsibleParam -obj $params -name SitePermissions -failifempty $False -resultobj $result
...
If ($ListPermissions)
{
    If (('Add Items','Approve Items','Create Alerts','Delete Items','Delete Versions','Edit Items','Manage Lists','Open Items','Override List Behaviors','View Application Pages','View Items','View Versions') -contains $ListPermissions ) {
    }
    Else
    {
        Fail-Json $result "Option ListPermissions has invalid value $ListPermissions. Valid values are 'Add Items','Approve Items','Create Alerts','Delete Items','Delete Versions','Edit Items','Manage Lists','Open Items','Override List Behaviors','View Application Pages','View Items','View Versions'"
    }
}
...
{
    If (('Add/Remove Personal Web Parts','Manage Personal Views','Update Personal Web Parts') -contains $PersonalPermissions ) {
    }
    Else
    {
        Fail-Json $result "Option PersonalPermissions has invalid value $PersonalPermissions. Valid values are 'Add/Remove Personal Web Parts','Manage Personal Views','Update Personal Web Parts'"
    }
}
...
If ($SitePermissions)
{
    If (('Add and Customize Pages','Apply Style Sheets','Apply Themes and Borders','Browse Directories','Browse User Information','Create Groups','Create Subsites','Edit Personal User Information','Enumerate Permissions','Manage Alerts','Manage Permissions','Manage Web Site','Open','Use Client Integration Features','Use Remote Interfaces','Use Self-Service Site Creation','View Pages','View Web Analytics Data') -contains $SitePermissions ) {
    }
    Else
    {
        Fail-Json $result "Option SitePermissions has invalid value $SitePermissions. Valid values are 'Add and Customize Pages','Apply Style Sheets','Apply Themes and Borders','Browse Directories','Browse User Information','Create Groups','Create Subsites','Edit Personal User Information','Enumerate Permissions','Manage Alerts','Manage Permissions','Manage Web Site','Open','Use Client Integration Features','Use Remote Interfaces','Use Self-Service Site Creation','View Pages','View Web Analytics Data'"
    }
}
...
$DscResourceName = "SPWebAppPermissions"
