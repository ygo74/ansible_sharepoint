...
#ATTRIBUTE:RMSserver;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RMSserver = Get-AnsibleParam -obj $params -name RMSserver -failifempty $False -resultobj $result
#ATTRIBUTE:UseADRMS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseADRMS = Get-AnsibleParam -obj $params -name UseADRMS -failifempty $False -resultobj $result
