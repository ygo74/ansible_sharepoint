...
#ATTRIBUTE:UserProfileService;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserProfileService = Get-AnsibleParam -obj $params -name UserProfileService -failifempty $True -resultobj $result
#ATTRIBUTE:Description;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Description = Get-AnsibleParam -obj $params -name Description -failifempty $False -resultobj $result
#ATTRIBUTE:DisplayName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisplayName = Get-AnsibleParam -obj $params -name DisplayName -failifempty $False -resultobj $result
#ATTRIBUTE:DisplayOrder;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisplayOrder = Get-AnsibleParam -obj $params -name DisplayOrder -failifempty $False -resultobj $result
...
$InstallAccount_username = Get-AnsibleParam -obj $params -name InstallAccount_username -failifempty $False -resultobj $result
#ATTRIBUTE:InstallAccount_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallAccount_password = Get-AnsibleParam -obj $params -name InstallAccount_password -failifempty $False -resultobj $result
#ATTRIBUTE:IsAlias;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsAlias = Get-AnsibleParam -obj $params -name IsAlias -failifempty $False -resultobj $result
#ATTRIBUTE:IsEventLog;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsEventLog = Get-AnsibleParam -obj $params -name IsEventLog -failifempty $False -resultobj $result
#ATTRIBUTE:IsSearchable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsSearchable = Get-AnsibleParam -obj $params -name IsSearchable -failifempty $False -resultobj $result
#ATTRIBUTE:IsUserEditable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsUserEditable = Get-AnsibleParam -obj $params -name IsUserEditable -failifempty $False -resultobj $result
#ATTRIBUTE:IsVisibleOnEditor;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsVisibleOnEditor = Get-AnsibleParam -obj $params -name IsVisibleOnEditor -failifempty $False -resultobj $result
#ATTRIBUTE:IsVisibleOnViewer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsVisibleOnViewer = Get-AnsibleParam -obj $params -name IsVisibleOnViewer -failifempty $False -resultobj $result
#ATTRIBUTE:Length;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Length = Get-AnsibleParam -obj $params -name Length -failifempty $False -resultobj $result
#ATTRIBUTE:MappingConnectionName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingConnectionName = Get-AnsibleParam -obj $params -name MappingConnectionName -failifempty $False -resultobj $result
#ATTRIBUTE:MappingDirection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingDirection = Get-AnsibleParam -obj $params -name MappingDirection -failifempty $False -resultobj $result
#ATTRIBUTE:MappingPropertyName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingPropertyName = Get-AnsibleParam -obj $params -name MappingPropertyName -failifempty $False -resultobj $result
#ATTRIBUTE:PolicySetting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Mandatory,Optin,Optout
$PolicySetting = Get-AnsibleParam -obj $params -name PolicySetting -failifempty $False -resultobj $result
#ATTRIBUTE:PrivacySetting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Contacts,Manager,Organization,Private,Public
$PrivacySetting = Get-AnsibleParam -obj $params -name PrivacySetting -failifempty $False -resultobj $result
...
#ATTRIBUTE:TermGroup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TermGroup = Get-AnsibleParam -obj $params -name TermGroup -failifempty $False -resultobj $result
#ATTRIBUTE:TermSet;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TermSet = Get-AnsibleParam -obj $params -name TermSet -failifempty $False -resultobj $result
#ATTRIBUTE:TermStore;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TermStore = Get-AnsibleParam -obj $params -name TermStore -failifempty $False -resultobj $result
#ATTRIBUTE:Type;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:BigInteger,Binary,Boolean,Date,DateNoYear,DateTime,Email,Float,Guid,HTML,Integer,Person,String,StringMultiValue,TimeZone,URL
$Type = Get-AnsibleParam -obj $params -name Type -failifempty $False -resultobj $result
#ATTRIBUTE:UserOverridePrivacy;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserOverridePrivacy = Get-AnsibleParam -obj $params -name UserOverridePrivacy -failifempty $False -resultobj $result
...
If ($PolicySetting)
{
    If (('Disabled','Mandatory','Optin','Optout') -contains $PolicySetting ) {
    }
    Else
    {
        Fail-Json $result "Option PolicySetting has invalid value $PolicySetting. Valid values are 'Disabled','Mandatory','Optin','Optout'"
    }
}
...
If ($PrivacySetting)
{
    If (('Contacts','Manager','Organization','Private','Public') -contains $PrivacySetting ) {
    }
    Else
    {
        Fail-Json $result "Option PrivacySetting has invalid value $PrivacySetting. Valid values are 'Contacts','Manager','Organization','Private','Public'"
    }
}
...
If ($Type)
{
    If (('BigInteger','Binary','Boolean','Date','DateNoYear','DateTime','Email','Float','Guid','HTML','Integer','Person','String','StringMultiValue','TimeZone','URL') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'BigInteger','Binary','Boolean','Date','DateNoYear','DateTime','Email','Float','Guid','HTML','Integer','Person','String','StringMultiValue','TimeZone','URL'"
    }
}
...
$InstallAccount = New-Object System.Management.Automation.PSCredential($InstallAccount_username,$InstallAccount_securepassword)
}
...
$DscResourceName = "SPUserProfileProperty"

$DscModuleName = "SharepointDSC"
