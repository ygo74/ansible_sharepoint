...
#ATTRIBUTE:LiteralPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LiteralPath = Get-AnsibleParam -obj $params -name LiteralPath -failifempty $True -resultobj $result
...
#ATTRIBUTE:Deployed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Deployed = Get-AnsibleParam -obj $params -name Deployed -failifempty $False -resultobj $result
...
#ATTRIBUTE:SolutionLevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:14,15,All
$SolutionLevel = Get-AnsibleParam -obj $params -name SolutionLevel -failifempty $False -resultobj $result
#ATTRIBUTE:Version;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Version = Get-AnsibleParam -obj $params -name Version -failifempty $False -resultobj $result
#ATTRIBUTE:WebApplications;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebApplications = Get-AnsibleParam -obj $params -name WebApplications -failifempty $False -resultobj $result
...
If ($SolutionLevel)
{
    If (('14','15','All') -contains $SolutionLevel ) {
    }
    Else
    {
        Fail-Json $result "Option SolutionLevel has invalid value $SolutionLevel. Valid values are '14','15','All'"
    }
}
...
$DscResourceName = "SPFarmSolution"
