...
#ATTRIBUTE:Prefix;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Prefix = Get-AnsibleParam -obj $params -name Prefix -failifempty $True -resultobj $result
