...
#ATTRIBUTE:CreatePersonalSite;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CreatePersonalSite = Get-AnsibleParam -obj $params -name CreatePersonalSite -failifempty $True -resultobj $result
#ATTRIBUTE:FollowAndEditProfile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FollowAndEditProfile = Get-AnsibleParam -obj $params -name FollowAndEditProfile -failifempty $True -resultobj $result
#ATTRIBUTE:ProxyName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyName = Get-AnsibleParam -obj $params -name ProxyName -failifempty $True -resultobj $result
#ATTRIBUTE:UseTagsAndNotes;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseTagsAndNotes = Get-AnsibleParam -obj $params -name UseTagsAndNotes -failifempty $True -resultobj $result
...
$DscResourceName = "SPUserProfileServiceAppPermissions"
