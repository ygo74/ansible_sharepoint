...
#ATTRIBUTE:ClaimsMappings;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClaimsMappings = Get-AnsibleParam -obj $params -name ClaimsMappings -failifempty $True -resultobj $result
#ATTRIBUTE:Description;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Description = Get-AnsibleParam -obj $params -name Description -failifempty $True -resultobj $result
#ATTRIBUTE:IdentifierClaim;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IdentifierClaim = Get-AnsibleParam -obj $params -name IdentifierClaim -failifempty $True -resultobj $result
...
#ATTRIBUTE:Realm;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Realm = Get-AnsibleParam -obj $params -name Realm -failifempty $True -resultobj $result
#ATTRIBUTE:SignInUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SignInUrl = Get-AnsibleParam -obj $params -name SignInUrl -failifempty $True -resultobj $result
#ATTRIBUTE:ClaimProviderName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClaimProviderName = Get-AnsibleParam -obj $params -name ClaimProviderName -failifempty $False -resultobj $result
...
#ATTRIBUTE:ProviderSignOutUri;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProviderSignOutUri = Get-AnsibleParam -obj $params -name ProviderSignOutUri -failifempty $False -resultobj $result
...
#ATTRIBUTE:SigningCertificateFilePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SigningCertificateFilePath = Get-AnsibleParam -obj $params -name SigningCertificateFilePath -failifempty $False -resultobj $result
#ATTRIBUTE:SigningCertificateThumbprint;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SigningCertificateThumbprint = Get-AnsibleParam -obj $params -name SigningCertificateThumbprint -failifempty $False -resultobj $result
...
$DscResourceName = "SPTrustedIdentityTokenIssuer"
