...
#ATTRIBUTE:Zone;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Custom,Default,Extranet,Internet,Intranet
$Zone = Get-AnsibleParam -obj $params -name Zone -failifempty $True -resultobj $result
#ATTRIBUTE:AllowAnonymous;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowAnonymous = Get-AnsibleParam -obj $params -name AllowAnonymous -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationMethod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Claims,Kerberos,NTLM
$AuthenticationMethod = Get-AnsibleParam -obj $params -name AuthenticationMethod -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationProvider;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationProvider = Get-AnsibleParam -obj $params -name AuthenticationProvider -failifempty $False -resultobj $result
...
#ATTRIBUTE:HostHeader;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HostHeader = Get-AnsibleParam -obj $params -name HostHeader -failifempty $False -resultobj $result
...
$Path = Get-AnsibleParam -obj $params -name Path -failifempty $False -resultobj $result
#ATTRIBUTE:Port;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Port = Get-AnsibleParam -obj $params -name Port -failifempty $False -resultobj $result
...
If ($Zone)
{
    If (('Custom','Default','Extranet','Internet','Intranet') -contains $Zone ) {
    }
    Else
    {
        Fail-Json $result "Option Zone has invalid value $Zone. Valid values are 'Custom','Default','Extranet','Internet','Intranet'"
    }
}
...
{
    If (('Claims','Kerberos','NTLM') -contains $AuthenticationMethod ) {
    }
    Else
    {
        Fail-Json $result "Option AuthenticationMethod has invalid value $AuthenticationMethod. Valid values are 'Claims','Kerberos','NTLM'"
    }
}
...
$DscResourceName = "SPWebApplicationExtension"
