...
#ATTRIBUTE:EnableNetBIOS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableNetBIOS = Get-AnsibleParam -obj $params -name EnableNetBIOS -failifempty $False -resultobj $result
...
#ATTRIBUTE:FarmAccount_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmAccount_username = Get-AnsibleParam -obj $params -name FarmAccount_username -failifempty $False -resultobj $result
#ATTRIBUTE:FarmAccount_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmAccount_password = Get-AnsibleParam -obj $params -name FarmAccount_password -failifempty $False -resultobj $result
...
$MySiteHostLocation = Get-AnsibleParam -obj $params -name MySiteHostLocation -failifempty $False -resultobj $result
#ATTRIBUTE:ProfileDBName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProfileDBName = Get-AnsibleParam -obj $params -name ProfileDBName -failifempty $False -resultobj $result
#ATTRIBUTE:ProfileDBServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProfileDBServer = Get-AnsibleParam -obj $params -name ProfileDBServer -failifempty $False -resultobj $result
...
$SocialDBName = Get-AnsibleParam -obj $params -name SocialDBName -failifempty $False -resultobj $result
#ATTRIBUTE:SocialDBServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SocialDBServer = Get-AnsibleParam -obj $params -name SocialDBServer -failifempty $False -resultobj $result
#ATTRIBUTE:SyncDBName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SyncDBName = Get-AnsibleParam -obj $params -name SyncDBName -failifempty $False -resultobj $result
#ATTRIBUTE:SyncDBServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SyncDBServer = Get-AnsibleParam -obj $params -name SyncDBServer -failifempty $False -resultobj $result
...
$DscResourceName = "SPUserProfileServiceApp"
