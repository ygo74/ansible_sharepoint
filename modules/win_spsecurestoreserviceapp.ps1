...
#ATTRIBUTE:AuditingEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuditingEnabled = Get-AnsibleParam -obj $params -name AuditingEnabled -failifempty $True -resultobj $result
...
#ATTRIBUTE:AuditlogMaxSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuditlogMaxSize = Get-AnsibleParam -obj $params -name AuditlogMaxSize -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseAuthenticationType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:SQL,Windows
$DatabaseAuthenticationType = Get-AnsibleParam -obj $params -name DatabaseAuthenticationType -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseCredentials_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseCredentials_username = Get-AnsibleParam -obj $params -name DatabaseCredentials_username -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseCredentials_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseCredentials_password = Get-AnsibleParam -obj $params -name DatabaseCredentials_password -failifempty $False -resultobj $result
...
#ATTRIBUTE:FailoverDatabaseServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FailoverDatabaseServer = Get-AnsibleParam -obj $params -name FailoverDatabaseServer -failifempty $False -resultobj $result
...
#ATTRIBUTE:PartitionMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PartitionMode = Get-AnsibleParam -obj $params -name PartitionMode -failifempty $False -resultobj $result
#ATTRIBUTE:ProxyName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyName = Get-AnsibleParam -obj $params -name ProxyName -failifempty $False -resultobj $result
...
#ATTRIBUTE:Sharing;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Sharing = Get-AnsibleParam -obj $params -name Sharing -failifempty $False -resultobj $result
...
If ($DatabaseAuthenticationType)
{
    If (('SQL','Windows') -contains $DatabaseAuthenticationType ) {
    }
    Else
    {
        Fail-Json $result "Option DatabaseAuthenticationType has invalid value $DatabaseAuthenticationType. Valid values are 'SQL','Windows'"
    }
}
...
if ($DatabaseCredentials_username)
{
$DatabaseCredentials_securepassword = $DatabaseCredentials_password | ConvertTo-SecureString -asPlainText -Force
$DatabaseCredentials = New-Object System.Management.Automation.PSCredential($DatabaseCredentials_username,$DatabaseCredentials_securepassword)
}
...
$DscResourceName = "SPSecureStoreServiceApp"
