...
#ATTRIBUTE:AllowAppPurchases;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowAppPurchases = Get-AnsibleParam -obj $params -name AllowAppPurchases -failifempty $False -resultobj $result
#ATTRIBUTE:AllowAppsForOffice;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowAppsForOffice = Get-AnsibleParam -obj $params -name AllowAppsForOffice -failifempty $False -resultobj $result
...
$DscResourceName = "SPAppStoreSettings"
