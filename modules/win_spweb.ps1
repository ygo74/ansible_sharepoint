...
#ATTRIBUTE:AddToQuickLaunch;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AddToQuickLaunch = Get-AnsibleParam -obj $params -name AddToQuickLaunch -failifempty $False -resultobj $result
#ATTRIBUTE:AddToTopNav;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AddToTopNav = Get-AnsibleParam -obj $params -name AddToTopNav -failifempty $False -resultobj $result
...
#ATTRIBUTE:UniquePermissions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UniquePermissions = Get-AnsibleParam -obj $params -name UniquePermissions -failifempty $False -resultobj $result
#ATTRIBUTE:UseParentTopNav;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseParentTopNav = Get-AnsibleParam -obj $params -name UseParentTopNav -failifempty $False -resultobj $result
