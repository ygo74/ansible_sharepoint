...
#ATTRIBUTE:SuperReaderAlias;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SuperReaderAlias = Get-AnsibleParam -obj $params -name SuperReaderAlias -failifempty $True -resultobj $result
#ATTRIBUTE:SuperUserAlias;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SuperUserAlias = Get-AnsibleParam -obj $params -name SuperUserAlias -failifempty $True -resultobj $result
...
#ATTRIBUTE:SetWebAppPolicy;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetWebAppPolicy = Get-AnsibleParam -obj $params -name SetWebAppPolicy -failifempty $False -resultobj $result
...
$DscResourceName = "SPCacheAccounts"
