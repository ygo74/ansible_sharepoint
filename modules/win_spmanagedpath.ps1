...
#ATTRIBUTE:Explicit;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Explicit = Get-AnsibleParam -obj $params -name Explicit -failifempty $True -resultobj $result
#ATTRIBUTE:HostHeader;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HostHeader = Get-AnsibleParam -obj $params -name HostHeader -failifempty $True -resultobj $result
#ATTRIBUTE:RelativeUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RelativeUrl = Get-AnsibleParam -obj $params -name RelativeUrl -failifempty $True -resultobj $result
