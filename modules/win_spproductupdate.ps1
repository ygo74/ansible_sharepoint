...
#ATTRIBUTE:SetupFile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetupFile = Get-AnsibleParam -obj $params -name SetupFile -failifempty $True -resultobj $result
#ATTRIBUTE:BinaryInstallDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:fri,mon,sat,sun,thu,tue,wed
$BinaryInstallDays = Get-AnsibleParam -obj $params -name BinaryInstallDays -failifempty $False -resultobj $result
#ATTRIBUTE:BinaryInstallTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BinaryInstallTime = Get-AnsibleParam -obj $params -name BinaryInstallTime -failifempty $False -resultobj $result
...
#ATTRIBUTE:ShutdownServices;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShutdownServices = Get-AnsibleParam -obj $params -name ShutdownServices -failifempty $False -resultobj $result
...
{
    If (('fri','mon','sat','sun','thu','tue','wed') -contains $BinaryInstallDays ) {
    }
    Else
    {
        Fail-Json $result "Option BinaryInstallDays has invalid value $BinaryInstallDays. Valid values are 'fri','mon','sat','sun','thu','tue','wed'"
    }
}
...
$DscResourceName = "SPProductUpdate"
