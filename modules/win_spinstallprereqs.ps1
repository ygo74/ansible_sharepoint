...
#ATTRIBUTE:InstallerPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallerPath = Get-AnsibleParam -obj $params -name InstallerPath -failifempty $True -resultobj $result
#ATTRIBUTE:OnlineMode;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OnlineMode = Get-AnsibleParam -obj $params -name OnlineMode -failifempty $True -resultobj $result
#ATTRIBUTE:AppFabric;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AppFabric = Get-AnsibleParam -obj $params -name AppFabric -failifempty $False -resultobj $result
#ATTRIBUTE:DotNetFx;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DotNetFx = Get-AnsibleParam -obj $params -name DotNetFx -failifempty $False -resultobj $result
...
#ATTRIBUTE:IDFX;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IDFX = Get-AnsibleParam -obj $params -name IDFX -failifempty $False -resultobj $result
#ATTRIBUTE:IDFX11;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IDFX11 = Get-AnsibleParam -obj $params -name IDFX11 -failifempty $False -resultobj $result
#ATTRIBUTE:KB2671763;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KB2671763 = Get-AnsibleParam -obj $params -name KB2671763 -failifempty $False -resultobj $result
#ATTRIBUTE:KB3092423;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KB3092423 = Get-AnsibleParam -obj $params -name KB3092423 -failifempty $False -resultobj $result
#ATTRIBUTE:MSIPCClient;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MSIPCClient = Get-AnsibleParam -obj $params -name MSIPCClient -failifempty $False -resultobj $result
#ATTRIBUTE:MSVCRT11;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MSVCRT11 = Get-AnsibleParam -obj $params -name MSVCRT11 -failifempty $False -resultobj $result
#ATTRIBUTE:MSVCRT14;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MSVCRT14 = Get-AnsibleParam -obj $params -name MSVCRT14 -failifempty $False -resultobj $result
#ATTRIBUTE:NETFX;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NETFX = Get-AnsibleParam -obj $params -name NETFX -failifempty $False -resultobj $result
#ATTRIBUTE:ODBC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ODBC = Get-AnsibleParam -obj $params -name ODBC -failifempty $False -resultobj $result
#ATTRIBUTE:PowerShell;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PowerShell = Get-AnsibleParam -obj $params -name PowerShell -failifempty $False -resultobj $result
...
#ATTRIBUTE:SQLNCli;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLNCli = Get-AnsibleParam -obj $params -name SQLNCli -failifempty $False -resultobj $result
#ATTRIBUTE:SXSpath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SXSpath = Get-AnsibleParam -obj $params -name SXSpath -failifempty $False -resultobj $result
#ATTRIBUTE:Sync;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Sync = Get-AnsibleParam -obj $params -name Sync -failifempty $False -resultobj $result
#ATTRIBUTE:WCFDataServices;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WCFDataServices = Get-AnsibleParam -obj $params -name WCFDataServices -failifempty $False -resultobj $result
#ATTRIBUTE:WCFDataServices56;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WCFDataServices56 = Get-AnsibleParam -obj $params -name WCFDataServices56 -failifempty $False -resultobj $result
...
$DscResourceName = "SPInstallPrereqs"
