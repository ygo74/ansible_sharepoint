...
#ATTRIBUTE:ProviderType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Exchange Search Provider,Local People Provider,Local SharePoint Provider,OpenSearch Provider,Remote People Provider,Remote SharePoint Provider
$ProviderType = Get-AnsibleParam -obj $params -name ProviderType -failifempty $True -resultobj $result
#ATTRIBUTE:Query;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Query = Get-AnsibleParam -obj $params -name Query -failifempty $True -resultobj $result
#ATTRIBUTE:SearchServiceAppName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SearchServiceAppName = Get-AnsibleParam -obj $params -name SearchServiceAppName -failifempty $True -resultobj $result
#ATTRIBUTE:ConnectionUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionUrl = Get-AnsibleParam -obj $params -name ConnectionUrl -failifempty $False -resultobj $result
...
If ($ProviderType)
{
    If (('Exchange Search Provider','Local People Provider','Local SharePoint Provider','OpenSearch Provider','Remote People Provider','Remote SharePoint Provider') -contains $ProviderType ) {
    }
    Else
    {
        Fail-Json $result "Option ProviderType has invalid value $ProviderType. Valid values are 'Exchange Search Provider','Local People Provider','Local SharePoint Provider','OpenSearch Provider','Remote People Provider','Remote SharePoint Provider'"
    }
}
...
$DscResourceName = "SPSearchResultSource"
