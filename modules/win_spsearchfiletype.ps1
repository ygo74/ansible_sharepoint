...
#ATTRIBUTE:FileType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FileType = Get-AnsibleParam -obj $params -name FileType -failifempty $True -resultobj $result
...
#ATTRIBUTE:MimeType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MimeType = Get-AnsibleParam -obj $params -name MimeType -failifempty $False -resultobj $result
...
$DscResourceName = "SPSearchFileType"
