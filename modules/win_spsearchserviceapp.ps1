...
#ATTRIBUTE:CloudIndex;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CloudIndex = Get-AnsibleParam -obj $params -name CloudIndex -failifempty $False -resultobj $result
...
$DefaultContentAccessAccount_username = Get-AnsibleParam -obj $params -name DefaultContentAccessAccount_username -failifempty $False -resultobj $result
#ATTRIBUTE:DefaultContentAccessAccount_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultContentAccessAccount_password = Get-AnsibleParam -obj $params -name DefaultContentAccessAccount_password -failifempty $False -resultobj $result
...
#ATTRIBUTE:SearchCenterUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SearchCenterUrl = Get-AnsibleParam -obj $params -name SearchCenterUrl -failifempty $False -resultobj $result
...
$DscResourceName = "SPSearchServiceApp"
