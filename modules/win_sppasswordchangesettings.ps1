...
#ATTRIBUTE:MailAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MailAddress = Get-AnsibleParam -obj $params -name MailAddress -failifempty $True -resultobj $result
#ATTRIBUTE:DaysBeforeExpiry;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DaysBeforeExpiry = Get-AnsibleParam -obj $params -name DaysBeforeExpiry -failifempty $False -resultobj $result
...
#ATTRIBUTE:NumberOfRetries;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfRetries = Get-AnsibleParam -obj $params -name NumberOfRetries -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordChangeWaitTimeSeconds;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordChangeWaitTimeSeconds = Get-AnsibleParam -obj $params -name PasswordChangeWaitTimeSeconds -failifempty $False -resultobj $result
...
$DscResourceName = "SPPasswordChangeSettings"
