...
#ATTRIBUTE:SecurityType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Administrators,SharingPermissions
$SecurityType = Get-AnsibleParam -obj $params -name SecurityType -failifempty $True -resultobj $result
...
$Members = Get-AnsibleParam -obj $params -name Members -failifempty $False -resultobj $result
#ATTRIBUTE:MembersToExclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MembersToExclude = Get-AnsibleParam -obj $params -name MembersToExclude -failifempty $False -resultobj $result
#ATTRIBUTE:MembersToInclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MembersToInclude = Get-AnsibleParam -obj $params -name MembersToInclude -failifempty $False -resultobj $result
...
If ($SecurityType)
{
    If (('Administrators','SharingPermissions') -contains $SecurityType ) {
    }
    Else
    {
        Fail-Json $result "Option SecurityType has invalid value $SecurityType. Valid values are 'Administrators','SharingPermissions'"
    }
}
...
$DscResourceName = "SPServiceAppSecurity"
