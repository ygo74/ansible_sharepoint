...
#ATTRIBUTE:Enabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Enabled = Get-AnsibleParam -obj $params -name Enabled -failifempty $True -resultobj $result
...
#ATTRIBUTE:FixAutomatically;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FixAutomatically = Get-AnsibleParam -obj $params -name FixAutomatically -failifempty $False -resultobj $result
...
#ATTRIBUTE:RuleScope;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:All Servers,Any Server
$RuleScope = Get-AnsibleParam -obj $params -name RuleScope -failifempty $False -resultobj $result
#ATTRIBUTE:Schedule;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Daily,Hourly,Monthly,OnDemandOnly,Weekly
...
If ($RuleScope)
{
    If (('All Servers','Any Server') -contains $RuleScope ) {
    }
    Else
    {
        Fail-Json $result "Option RuleScope has invalid value $RuleScope. Valid values are 'All Servers','Any Server'"
    }
}
...
If ($Schedule)
{
    If (('Daily','Hourly','Monthly','OnDemandOnly','Weekly') -contains $Schedule ) {
    }
    Else
    {
        Fail-Json $result "Option Schedule has invalid value $Schedule. Valid values are 'Daily','Hourly','Monthly','OnDemandOnly','Weekly'"
    }
}
...
$DscResourceName = "SPHealthAnalyzerRuleState"
