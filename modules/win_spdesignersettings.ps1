...
#ATTRIBUTE:SettingsScope;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:SiteCollection,WebApplication
$SettingsScope = Get-AnsibleParam -obj $params -name SettingsScope -failifempty $True -resultobj $result
...
#ATTRIBUTE:AllowCreateDeclarativeWorkflow;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowCreateDeclarativeWorkflow = Get-AnsibleParam -obj $params -name AllowCreateDeclarativeWorkflow -failifempty $False -resultobj $result
#ATTRIBUTE:AllowCustomiseMasterPage;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowCustomiseMasterPage = Get-AnsibleParam -obj $params -name AllowCustomiseMasterPage -failifempty $False -resultobj $result
#ATTRIBUTE:AllowDetachPagesFromDefinition;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowDetachPagesFromDefinition = Get-AnsibleParam -obj $params -name AllowDetachPagesFromDefinition -failifempty $False -resultobj $result
#ATTRIBUTE:AllowManageSiteURLStructure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowManageSiteURLStructure = Get-AnsibleParam -obj $params -name AllowManageSiteURLStructure -failifempty $False -resultobj $result
#ATTRIBUTE:AllowSaveDeclarativeWorkflowAsTemplate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowSaveDeclarativeWorkflowAsTemplate = Get-AnsibleParam -obj $params -name AllowSaveDeclarativeWorkflowAsTemplate -failifempty $False -resultobj $result
#ATTRIBUTE:AllowSavePublishDeclarativeWorkflow;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowSavePublishDeclarativeWorkflow = Get-AnsibleParam -obj $params -name AllowSavePublishDeclarativeWorkflow -failifempty $False -resultobj $result
#ATTRIBUTE:AllowSharePointDesigner;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowSharePointDesigner = Get-AnsibleParam -obj $params -name AllowSharePointDesigner -failifempty $False -resultobj $result
...
If ($SettingsScope)
{
    If (('SiteCollection','WebApplication') -contains $SettingsScope ) {
    }
    Else
    {
        Fail-Json $result "Option SettingsScope has invalid value $SettingsScope. Valid values are 'SiteCollection','WebApplication'"
    }
}
...
$DscResourceName = "SPDesignerSettings"
