...
$UserName = Get-AnsibleParam -obj $params -name UserName -failifempty $True -resultobj $result
...
#ATTRIBUTE:Disabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Disabled = Get-AnsibleParam -obj $params -name Disabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:FullName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FullName = Get-AnsibleParam -obj $params -name FullName -failifempty $False -resultobj $result
#ATTRIBUTE:Password_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Password_username = Get-AnsibleParam -obj $params -name Password_username -failifempty $False -resultobj $result
#ATTRIBUTE:Password_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Password_password = Get-AnsibleParam -obj $params -name Password_password -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordChangeNotAllowed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordChangeNotAllowed = Get-AnsibleParam -obj $params -name PasswordChangeNotAllowed -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordChangeRequired;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordChangeRequired = Get-AnsibleParam -obj $params -name PasswordChangeRequired -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordNeverExpires;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordNeverExpires = Get-AnsibleParam -obj $params -name PasswordNeverExpires -failifempty $False -resultobj $result
...
$DscResourceName = "User"

$DscModuleName = "PSDesiredStateConfiguration"
