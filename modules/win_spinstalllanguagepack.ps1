...
#ATTRIBUTE:BinaryDir;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BinaryDir = Get-AnsibleParam -obj $params -name BinaryDir -failifempty $True -resultobj $result
...
$DscResourceName = "SPInstallLanguagePack"
