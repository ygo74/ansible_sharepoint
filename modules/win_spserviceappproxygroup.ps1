...
#ATTRIBUTE:ServiceAppProxies;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppProxies = Get-AnsibleParam -obj $params -name ServiceAppProxies -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceAppProxiesToExclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppProxiesToExclude = Get-AnsibleParam -obj $params -name ServiceAppProxiesToExclude -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceAppProxiesToInclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppProxiesToInclude = Get-AnsibleParam -obj $params -name ServiceAppProxiesToInclude -failifempty $False -resultobj $result
...
$DscResourceName = "SPServiceAppProxyGroup"
