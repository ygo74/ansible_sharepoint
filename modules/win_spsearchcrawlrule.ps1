...
#ATTRIBUTE:ServiceAppName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppName = Get-AnsibleParam -obj $params -name ServiceAppName -failifempty $True -resultobj $result
#ATTRIBUTE:AuthenticationCredentials_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationCredentials_username = Get-AnsibleParam -obj $params -name AuthenticationCredentials_username -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationCredentials_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationCredentials_password = Get-AnsibleParam -obj $params -name AuthenticationCredentials_password -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AnonymousAccess,BasicAccountRuleAccess,CertificateRuleAccess,CookieRuleAccess,DefaultRuleAccess,FormRuleAccess,NTLMAccountRuleAccess
$AuthenticationType = Get-AnsibleParam -obj $params -name AuthenticationType -failifempty $False -resultobj $result
#ATTRIBUTE:CertificateName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificateName = Get-AnsibleParam -obj $params -name CertificateName -failifempty $False -resultobj $result
#ATTRIBUTE:CrawlConfigurationRules;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:CrawlAsHTTP,CrawlComplexUrls,FollowLinksNoPageCrawl
$CrawlConfigurationRules = Get-AnsibleParam -obj $params -name CrawlConfigurationRules -failifempty $False -resultobj $result
...
#ATTRIBUTE:RuleType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:ExclusionRule,InclusionRule
$RuleType = Get-AnsibleParam -obj $params -name RuleType -failifempty $False -resultobj $result
...
{
    If (('AnonymousAccess','BasicAccountRuleAccess','CertificateRuleAccess','CookieRuleAccess','DefaultRuleAccess','FormRuleAccess','NTLMAccountRuleAccess') -contains $AuthenticationType ) {
    }
    Else
    {
        Fail-Json $result "Option AuthenticationType has invalid value $AuthenticationType. Valid values are 'AnonymousAccess','BasicAccountRuleAccess','CertificateRuleAccess','CookieRuleAccess','DefaultRuleAccess','FormRuleAccess','NTLMAccountRuleAccess'"
    }
}
...
{
    If (('CrawlAsHTTP','CrawlComplexUrls','FollowLinksNoPageCrawl') -contains $CrawlConfigurationRules ) {
    }
    Else
    {
        Fail-Json $result "Option CrawlConfigurationRules has invalid value $CrawlConfigurationRules. Valid values are 'CrawlAsHTTP','CrawlComplexUrls','FollowLinksNoPageCrawl'"
    }
}
...
If ($RuleType)
{
    If (('ExclusionRule','InclusionRule') -contains $RuleType ) {
    }
    Else
    {
        Fail-Json $result "Option RuleType has invalid value $RuleType. Valid values are 'ExclusionRule','InclusionRule'"
    }
}
...
if ($AuthenticationCredentials_username)
{
$AuthenticationCredentials_securepassword = $AuthenticationCredentials_password | ConvertTo-SecureString -asPlainText -Force
$AuthenticationCredentials = New-Object System.Management.Automation.PSCredential($AuthenticationCredentials_username,$AuthenticationCredentials_securepassword)
}
...
$DscResourceName = "SPSearchCrawlRule"
