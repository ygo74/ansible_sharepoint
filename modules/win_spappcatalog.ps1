...
#ATTRIBUTE:SiteUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteUrl = Get-AnsibleParam -obj $params -name SiteUrl -failifempty $True -resultobj $result
