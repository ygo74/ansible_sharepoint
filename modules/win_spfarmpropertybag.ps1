...
$Key = Get-AnsibleParam -obj $params -name Key -failifempty $True -resultobj $result
...
$Value = Get-AnsibleParam -obj $params -name Value -failifempty $False -resultobj $result
...
$DscResourceName = "SPFarmPropertyBag"
