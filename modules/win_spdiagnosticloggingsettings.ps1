...
$LogPath = Get-AnsibleParam -obj $params -name LogPath -failifempty $True -resultobj $result
#ATTRIBUTE:LogSpaceInGB;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogSpaceInGB = Get-AnsibleParam -obj $params -name LogSpaceInGB -failifempty $True -resultobj $result
#ATTRIBUTE:AppAnalyticsAutomaticUploadEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AppAnalyticsAutomaticUploadEnabled = Get-AnsibleParam -obj $params -name AppAnalyticsAutomaticUploadEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:CustomerExperienceImprovementProgramEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CustomerExperienceImprovementProgramEnabled = Get-AnsibleParam -obj $params -name CustomerExperienceImprovementProgramEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:DaysToKeepLogs;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DaysToKeepLogs = Get-AnsibleParam -obj $params -name DaysToKeepLogs -failifempty $False -resultobj $result
#ATTRIBUTE:DownloadErrorReportingUpdatesEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DownloadErrorReportingUpdatesEnabled = Get-AnsibleParam -obj $params -name DownloadErrorReportingUpdatesEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:ErrorReportingAutomaticUploadEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ErrorReportingAutomaticUploadEnabled = Get-AnsibleParam -obj $params -name ErrorReportingAutomaticUploadEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:ErrorReportingEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ErrorReportingEnabled = Get-AnsibleParam -obj $params -name ErrorReportingEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:EventLogFloodProtectionEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventLogFloodProtectionEnabled = Get-AnsibleParam -obj $params -name EventLogFloodProtectionEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:EventLogFloodProtectionNotifyInterval;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventLogFloodProtectionNotifyInterval = Get-AnsibleParam -obj $params -name EventLogFloodProtectionNotifyInterval -failifempty $False -resultobj $result
#ATTRIBUTE:EventLogFloodProtectionQuietPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventLogFloodProtectionQuietPeriod = Get-AnsibleParam -obj $params -name EventLogFloodProtectionQuietPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:EventLogFloodProtectionThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventLogFloodProtectionThreshold = Get-AnsibleParam -obj $params -name EventLogFloodProtectionThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:EventLogFloodProtectionTriggerPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventLogFloodProtectionTriggerPeriod = Get-AnsibleParam -obj $params -name EventLogFloodProtectionTriggerPeriod -failifempty $False -resultobj $result
...
$LogCutInterval = Get-AnsibleParam -obj $params -name LogCutInterval -failifempty $False -resultobj $result
#ATTRIBUTE:LogMaxDiskSpaceUsageEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogMaxDiskSpaceUsageEnabled = Get-AnsibleParam -obj $params -name LogMaxDiskSpaceUsageEnabled -failifempty $False -resultobj $result
...
$ScriptErrorReportingDelay = Get-AnsibleParam -obj $params -name ScriptErrorReportingDelay -failifempty $False -resultobj $result
#ATTRIBUTE:ScriptErrorReportingEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScriptErrorReportingEnabled = Get-AnsibleParam -obj $params -name ScriptErrorReportingEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:ScriptErrorReportingRequireAuth;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScriptErrorReportingRequireAuth = Get-AnsibleParam -obj $params -name ScriptErrorReportingRequireAuth -failifempty $False -resultobj $result
...
$DscResourceName = "SPDiagnosticLoggingSettings"
